...
<div class="tab-pane <%= TabPane("pet") %>" id="tabPet">
    ...
    <div class="row project-overview-stack">
        ...
        <div class="col-md-6">
            <asp:Panel ID="pnlLinesGrid" runat="server" Visible="false">
            <div class="card-panel panel-spend-request">
                <div class="card-panel-hdr">
                    <i class="bi bi-list-ul"></i> Spend Request Line Items
                    <small style="font-weight:400;color:#2563eb;">&mdash; <%= Server.HtmlEncode(string.IsNullOrEmpty(PetRefNo) ? "(unsaved)" : PetRefNo) %></small>
                    <div style="margin-left:auto;display:flex;gap:6px;flex-wrap:wrap;">
                    <% if (IsEditable) { %>
                    <asp:LinkButton ID="btnAddLine" runat="server" CssClass="btn btn-xs btn-success"
                        OnClick="btnAddLine_Click"><i class="bi bi-plus-circle"></i> Add Line</asp:LinkButton>
                    <% } %>
                    <% if (CurrentPetFormId > 0) { %>
                    <asp:LinkButton ID="btnExportPetLines" runat="server" CssClass="btn btn-xs btn-default"
                        OnClick="btnExportPetLines_Click" CausesValidation="false"><i class="bi bi-download"></i> Export CSV</asp:LinkButton>
                    <% } %>
                    </div>
                </div>
                <div class="card-panel-body" style="padding:0;overflow-x:auto;">
                    <asp:GridView ID="gvLines" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Actions" ItemStyle-Width="64px" ItemStyle-CssClass="action-cell">
                                <ItemTemplate>
                                    <div class="gv-acts">
            ...
            <div class="modal-content">
                <div class="modal-header" style="background:#1a3c5e;color:#fff;">
                    ...
                    <h4 class="modal-title" id="lineModalLabel">
                        ...
                        <asp:Literal ID="litLineModalTitle" runat="server" Text="New Line Item" />
                    </h4>
                </div>
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnSaveLine" runat="server" CssClass="btn btn-success" Text="Save" OnClick="btnSaveLine_Click" />
