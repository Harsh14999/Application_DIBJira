<%@ Page Title="OPEX Master" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="OpexMaster.aspx.cs" Inherits="DFM_BPM.Admin.OpexMaster" %>
...
<asp:Content ID="MainCt" ContentPlaceHolderID="MainContent" runat="server">
    <h1 class="page-title"><i class="bi bi-receipt"></i> OPEX Master
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px;">
        <div class="form-group" style="flex:2;">
            <label>Search by OPEX ID or Description</label>
            <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="e.g. OPEX-CET..." />
        </div>
        <div class="form-group"><label>&nbsp;</label>
            <asp:LinkButton ID="btnSearch" runat="server" CssClass="btn btn-primary" OnClick="btnSearch_Click">
                <i class="bi bi-search"></i> Search</asp:LinkButton></div>
        <div class="form-group"><label>&nbsp;</label>
            <asp:LinkButton ID="btnExport" runat="server" CssClass="btn btn-success" OnClick="btnExport_Click">
                <i class="bi bi-file-excel"></i> Excel</asp:LinkButton></div>
        <div class="form-group"><label>&nbsp;</label>
            <asp:Button ID="btnNewEntry" runat="server" CssClass="btn btn-info" Text="+ New OPEX" OnClick="btnNewEntry_Click" CausesValidation="false" /></div>
    </div>

    <!-- CSV Upload -->
    <div class="card-panel">
        <div class="dfm-panel-hdr" onclick="DFM.togglePanel('opexUploadBody','opexUpChev')">
            <i id="opexUpChev" class="bi bi-chevron-right dfm-panel-chev"></i>
            <i class="bi bi-upload"></i> Import from CSV
            <small style="font-size:.8em;color:#94a3b8;margin-left:8px;">Format: Type,ID,Description,Budget,Utilization,Available Budget,Locked Amt,Budget after Locked Amt,Claim Amt,Net Balance</small>
        </div>
        <div id="opexUploadBody" class="dfm-panel-body" style="display:none;">
            <div style="display:flex;gap:12px;align-items:flex-end;flex-wrap:wrap;padding:12px;">
                <div class="form-group" style="flex:1;min-width:220px;">
                    <label>Select OPEX CSV File</label>
                    <asp:FileUpload ID="fuOpex" runat="server" CssClass="form-control" Accept=".csv" />
                </div>
    ...
    <!-- Grid -->
    <div class="card-panel">
        <div class="card-panel-hdr"><i class="bi bi-table"></i> OPEX Entries (<asp:Literal ID="litCount" runat="server" Text="0" />)</div>
        <div class="card-panel-body" style="padding:0;overflow-x:auto;">
            <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false"
                CssClass="dfm-table" GridLines="None" DataKeyNames="OpexID"
                OnRowCommand="gv_RowCommand"
                AllowPaging="true" PageSize="20" OnPageIndexChanging="gv_PageIndexChanging"
                EmptyDataText="No OPEX entries.">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Actions">
                        ...
                        <ItemTemplate>
                            <div class="gv-acts">
                                <asp:LinkButton runat="server" CssClass="btn btn-xs btn-primary" CommandName="EditRow" CommandArgument='<%# Eval("OpexID") %>'><i class="bi bi-pencil"></i> Edit</asp:LinkButton>
                                <asp:LinkButton runat="server" CssClass="btn btn-xs btn-secondary" CommandName="ViewHist" CommandArgument='<%# Eval("OpexID") %>'><i class="bi bi-clock-history"></i> History</asp:LinkButton>
                                <asp:LinkButton runat="server" CssClass="btn btn-xs btn-danger" CommandName="DeleteRow" CommandArgument='<%# Eval("OpexID") %>' OnClientClick="return dfmDelConfirm(this);"><i class="bi bi-trash"></i></asp:LinkButton>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding:16px;">
                    ...
                    <div class="form-grid-5">
                        <div class="form-group"><label>OPEX ID <span style="color:#dc2626;">*</span></label><asp:TextBox ID="txtId" runat="server" CssClass="form-control" /></div>
